...
(PCAplot_vst <- ggplot(
  ...
  ggtitle("PCA Plot - BL6 InfectedvsControl") +
...
ggsave(
  filename = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/IvC/PCAplot23_InfectedvsControl.png",
  plot = PCAplot_vst23,
  dpi = 300,
  width = 10,
  height = 10,
...
ggsave(
  filename = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/IvC/PCAplot34_InfectedvsControl.png",
  plot = PCAplot_vst34,
  dpi = 300,
  width = 10,
  height = 10,
...
(PCAplot_ER <- ggplot(
  ...
  ggtitle("PCA Plot - BL6 InfectedvsControl - Epithelial_response") +
  theme.my.own)
...
(PCAplot_MC <- ggplot(
  ...
  ggtitle("PCA Plot - BL6 InfectedvsControl - Microcolonies") +
  theme.my.own)
...
(PCAplot_CO <- ggplot(
  ...
  ggtitle("PCA Plot - BL6 InfectedVsControl - Clinical Outcome") +
  theme.my.own)
...
(PCAplot_ERMC <- ggplot(
  ...
  ggtitle("PCA Plot - BL6 InfectedVsControl - ER_Microcolonies") +
  theme.my.own)
...
(PCAplot_PL <- ggplot(
  ...
  ggtitle("PCA Plot - BL6 InfectedVsControl - Phylogenomic Lineage") +
  theme.my.own)
...
(PCAplot_PG <- ggplot(
  ...
  ggtitle("PCA Plot - BL6 InfectedVsControl - Phylogroup") +
  theme.my.own)
...
(PCAplot_IT <- ggplot(
  ...
  ggtitle("PCA Plot - BL6 InfectedVs Control - Intimin type") +
  theme.my.own)
...
ggsave(
  filename = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/IvC/Volcano1_L2fcVsPvalue.png",
  plot = volcano1,
  dpi = 300,
  width = 5,
  height = 5,
...
ggsave(
  filename = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/IvC/Volcano2_L2fcVsPadj.png",
  plot = volcano2,
  dpi = 300,
  width = 10,
  height = 10,
