...
library('clusterProfiler')
library('PCAtools')
>>>>>>> 8bb163c53d3d5385b53e4946f7ba37f01ecd8fde
```
...
sample_ID <- read.csv("~/R/Rtuts/Data/WG__Discussion_Alina's_EPEC_project/samples.csv")
...
```{r}
countsmatrix <-as.matrix(read.csv("~/R/Rtuts/Data/WG__Discussion_Alina's_EPEC_project/counts.csv"))
```
...
#print(PCAplot_vst)
ggsave(filename = '~/R/Rtuts/Data/Alina_EPEC_project/plots/PCA_vst_plot.tiff', plot = PCAplot_vst)
```
