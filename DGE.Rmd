...
PCAdata_infected_ER <- plotPCA(vsd, intgroup = c("Sample_Name", 
                                                 "Epithelial_response"), 
                               returnData = TRUE)
percentVar_epithelial <- percentvar_calculation(PCAdata_infected_ER)
...
```
```{r}
write.csv(GO_UpRegdf_infected ,"~/R/Alina_RNAseq/InfectedVsControl/GO_UpReg_results.csv")
```

```{r}
savingGOPlots <- function(plot){
  # Function to save the GO Plots
  ggsave(filename = glue('~/R/Alina_RNAseq/InfectedVsControl/{plot}.png'),
       plot = plot,
       dpi = 300,
       width = 10,
       height = 10,
...
GO_UPReg_Barplot_infected <- plot(barplot(GO_UPRegResults_infected, 
                                           showCategory = 23))
#savingGOPlots(UPReg_Barplot_infected)
ggsave(filename = '~/R/Alina_RNAseq/InfectedVsControl/GO_UPReg_Barplot_infected.png', 
       plot = GO_UPReg_Barplot_infected, 
       dpi = 300,
       width = 12,
       height = 10,
       units = "in")
...
ggsave(filename = '~/R/Alina_RNAseq/InfectedVsControl/GO_UPReg_Dotplot_infected.png', 
       plot = GO_UPReg_Dotplot_infected, 
       dpi = 300,
       width = 12,
       height = 10,
       units = "in")
...
ggsave(filename = '~/R/Alina_RNAseq/InfectedVsControl/GO_UPReg_Cnetplot_infected.png', 
       plot = GO_UPReg_Cnetplot_infected, 
       dpi = 300,
       width = 12,
       height = 10,
       units = "in")
