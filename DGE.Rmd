...
#print(PCAplot_vst)
ggsave(filename = 'C:/Users/User/Documents/bam/plots/PCA_vst_plot1.tiff', plot = PCAplot_vst)
```
...
```{r}
head(sigs.df)
write.csv(sigs.df ,"C:/Users/User/Documents/bam/Data_Alina_padjANDlog2FC_thresholdimposed.csv")
```
