...
```{r}
write.csv(as.data.frame(resOrdered_infected), file = "~/R/Alina_RNAseq/InfectedVsControl/results_DGE_InfectedVsControl.csv")
```
...
```{r}
sigsdf_infected <- filter(sigsdf_infected, symbol != "Xist", symbol !="Jpx", symbol !="Ftx", symbol !="Tsx", symbol != "Cnbp2" )
```
