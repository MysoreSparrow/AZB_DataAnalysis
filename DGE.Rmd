...
```{r}
GO_fit_UPReg <- plot(barplot(GO_UPReg_results, showCategory = 9))
```
```{r}
...
```{r}
GO_fit_UPReg_dot <- plot(dotplot(GO_UPReg_results, showCategory = 13))
```
...
```{r}
GO_fit_UPReg_cnet <- plot(cnetplot(GO_UPReg_results, showCategory = 7))
```
```{r}
