...
saveplot <- function(plot,name ){
  ...
  ggsave(filename = 
           glue('~/R/Alina_RNAseq/InfectedVsControl/{name}.png'),
       plot = plot,
       dpi = 300,
       width = 10,
       height = 10,
...
savingFunction <- function(plotname, metadatacolumn){
  ...
  ggsave(filename = 
           glue('~/R/Alina_RNAseq/InfectedVsControl/PCAplot_InfectedVsControl_{metadatacolumn}.png'),
       plot = plotname,
       dpi = 300,
       width = 10,
       height = 10,
...
ggsave(filename = '~/R/Alina_RNAseq/InfectedVsControl/Volcano2_L2fcVsPvalue.png',
       plot = volcano1,
       dpi = 300,
       width = 10,
       height = 10,
...
ggsave(filename = '~/R/Alina_RNAseq/InfectedVsControl/Volcano2_L2fcVsPadj.png',
       plot = volcano2,
       dpi = 300,
       width = 10,
       height = 10,
...
```{r}
write.csv(DE_Genes_table_Infected ,"~/R/Alina_RNAseq/InfectedVsControl/DE_GenesTable_InfectedVsControl.csv")
...
```{r}
write.csv(GO_UpRegdf_infected ,"~/R/Alina_RNAseq/InfectedVsControl/GO_UpReg_results_infected.csv")
```
```{r}
...
write.csv(GO_DOWNRegdf_infected,
          "~/R/Alina_RNAseq/InfectedVsControl/GO_DOWNReg_results_infected.csv")
```
...
tmp = sapply(keggresids, function(pid) pathview(gene.data = foldchanges, 
                                                ...
                                                species = "mouse"))
```
![mmu04144](pathwayimages/mmu04144.pathview.png)
![mmu04144](pathwayimages/mmu03008.pathview.png)
![mmu04144](pathwayimages/mmu04141.pathview.png)
![mmu04144](pathwayimages/mmu04740.pathview.png)
![mmu04144](pathwayimages/mmu03010.pathview.png)

![mmu04144](pathwayimages/mmu04622.pathview.png)
![mmu04144](pathwayimages/mmu04744.pathview.png)

![mmu04144](pathwayimages/mmu04062.pathview.png)
![mmu04144](pathwayimages/mmu04666.pathview.png)

![mmu04144](pathwayimages/mmu00190.pathview.png)
