...
```{r}
select <- order(rowMeans(counts(dds2_infected,normalized = FALSE)),decreasing = TRUE)[1:20]
...
write.csv(sigsdf_infected ,"/home/keshavprasadgubbi/Documents/AlinaRnaSeq/IvC/SignificantGenes_ER.csv")
```
...
```{r}
write.csv(DE_Genes_table_infected ,"/home/keshavprasadgubbi/Documents/AlinaRnaSeq/IvC/DEGenesTable_ER.csv")
head(DE_Genes_table_infected, 25)
```
