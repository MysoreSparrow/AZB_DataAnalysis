---
title: 'DGE Analysis Notebook - ER_Microcolonies: 755 vs LI'
output:
  html_document: 
    toc: yes
    fig_width: 8
...
saveplot <- function(plot,name ){
  ...
  ggsave(filename = 
           glue('/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/{name}.png'),
       plot = plot,
       dpi = 300,
       width = 10,
       height = 10,
...
savingFunction <- function(plotname, metadatacolumn){
  ...
  ggsave(filename = 
           glue('/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/PCAplot_HighVsLowInducer_{metadatacolumn}.png'),
       plot = plotname,
       dpi = 300,
       width = 10,
       height = 10,
...
ggsave(filename = '/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/PCAplot23_HighVsLowInducer_ermc.png',
       plot = PCAplot_vst23,
       dpi = 300,
       width = 10,
       height = 10,
...
ggsave(filename = '/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/PCAplot34_HighVsLowInducer_ermc.png',
       plot = PCAplot_vst34,
       dpi = 300,
       width = 10,
       height = 10,
...
(PCAplot_MC <- ggplot(PCAdata_ermc_MC,
        ...
        ggtitle("PCA Plot - 755vsLI - Microcolonies") +
        theme.my.own)
...
(PCAplot_CO <- ggplot(PCAdata_ermc_CO,
        ...
        ggtitle("PCA Plot - 755vsLI - Clinical Outcome") +
        theme.my.own)
...
(PCAplot_PL <- ggplot(PCAdata_ermc_PL,
        ...
        ggtitle("PCA Plot - 755vsLI - Phylogenomic Lineage") +
        theme.my.own)
...
(PCAplot_PG <- ggplot(PCAdata_ermc_PG,
        ...
        ggtitle("PCA Plot - 755vsLI - Phylogroup") +
        theme.my.own)
...
(PCAplot_IT <- ggplot(PCAdata_ermc_IT,
        ...
        ggtitle("PCA Plot - 755vsLI - Intimin type") +
        theme.my.own)
...
(Hclust_plot <- pheatmap(rld_cor, 
                        ...
                        #filename = '/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/Hclust_plot.tiff'
                       ))
#Hclust_plot
```
...
```{r}
res_ermc <- results(dds1_ermc, contrast = c("ER_microcolonies","HI_LM","LI_LM"))
head(res_ermc, 30)
```
...
write.csv(as.data.frame(resOrdered_ermc),
          file = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/results_DGE_ER.csv")
```
...
ggsave(filename = '/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/Volcano1_L2fcVsPvalue.png',
       plot = volcano1,
       dpi = 300,
       width = 5,
       height = 5,
...
ggsave(filename = '/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/Volcano2_L2fcVsPadj.png',
       plot = volcano2,
       dpi = 300,
       width = 10,
       height = 10,
...
write.csv(sigsdf_ermc ,"/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/SignificantGenes_ER.csv")
```
...
```{r}
write.csv(DE_Genes_table_ermc ,"/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/DEGenesTable_ER.csv")
...
```{r}
write.csv(GO_UpRegdf_ermc ,"/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/GO_UpReg_results_Epithelial.csv")
```
...
write.csv(GO_DOWNRegdf_ermc,
          "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/GO_DOWNReg_results_Epithelial.csv")
```
...
# 
# write.csv(gseaKEGG_results, "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/755vsLI/gseaOE_kegg.csv")
```
