...
distance_plot <- pheatmap(sampleDistMatrix,
         ...
         main = "Sample-to-Sample Euclidean Distance of BL6 - Epithelial Response",
         col = colors)
distance_plot
```
...
poisson_dist_plot <- pheatmap(samplePoisDistMatrix,
         ...
         main = "Sample-to-Sample Poisson Distance of BL6 - Epithelial Response",
         col = colors)
...
```{r}
pcaData_epithelial <- plotPCA(vsd, intgroup = c("Epithelial_response","Sample_Name"), returnData = TRUE)
head(pcaData_epithelial)
percentVar_epithelial <- round(100 * attr(pcaData_epithelial, "percentVar"), digits = 3 )
percentVar_epithelial
```
...
PCAplot_vst <- ggplot(pcaData_epithelial,
  ...
  ggtitle("PCA Plot - High Vs Low Inducer - Epithelial Response") +
  theme_classic() +
...
PCAplot_vst
ggsave(filename = '~/R/Alina_RNAseq/EpithelialResponse/PCAplot_EpithelialResponse.png',
       plot = PCAplot_vst,
       dpi = 300,
       width = 10,
       height = 10,
...
```{r}
PCAdata_epithelial_ER <- plotPCA(vsd, intgroup = c("Sample_Name", "Epithelial_response"), returnData = TRUE)
head(PCAdata_epithelial_ER)
percentVar.PCAdata_epithelial_ER <- round(100 * attr(PCAdata_epithelial_ER, "percentVar"), digits = 4)
```

```{r}
PCAplot_ER <- ggplot(PCAdata_epithelial_ER,
                     aes(x = PC1, y = PC2, color = Epithelial_response, label= Sample_Name)) +
  geom_point(size = 3) +
  xlab(paste0("PC1: ", percentVar.PCAdata_epithelial_ER[1], "% variance")) +
  ylab(paste0("PC2: ", percentVar.PCAdata_epithelial_ER[2], "% variance")) +
  coord_fixed() +
  scale_y_continuous(breaks = seq(-10, 10, 5)) +
  scale_x_continuous(breaks = seq(-20, 20, 5)) +
  ggtitle("PCA Plot - High Vs Low Inducer - Epithelial Response") +
...
PCAplot_ER
ggsave(filename = '~/R/Alina_RNAseq/EpithelialResponse/PCAplot_EpithelialResponse_EpithelialResponse.png',
       plot = PCAplot_ER,
       dpi = 300,
       width = 10,
       height = 10,
...
head(PCAdata_epithelial_MC)
percentVar.PCAdata_epithelial_MC <- round(100 * attr(PCAdata_epithelial_MC, "percentVar"), digits = 4)
```
...
PCAplot_MC <- ggplot(PCAdata_epithelial_MC,
                     aes(x = PC1, y = PC2,
                         ...
                         label= Sample_Name)) +
  geom_point(size = 3) +
  xlab(paste0("PC1: ", percentVar.PCAdata_epithelial_MC[1], "% variance")) +
  ylab(paste0("PC2: ", percentVar.PCAdata_epithelial_MC[2], "% variance")) +
  coord_fixed() +
  scale_y_continuous(breaks = seq(-10, 10, 5)) +
  scale_x_continuous(breaks = seq(-20, 20, 5)) +
  ...
  geom_text(size = 4, hjust = 0, vjust = 0)
PCAplot_MC
ggsave(filename = '~/R/Alina_RNAseq/EpithelialResponse/PCAplot_EpithelialResponse_Microcolonies.png',
       plot = PCAplot_MC,
       dpi = 300,
       width = 10,
       height = 10,
...
```{r}
PCAdata_epithelial_CO <- plotPCA(vsd, intgroup = c("Sample_Name", "clinical_outcome"), returnData = TRUE)
head(PCAdata_epithelial_CO)
percentVar.PCAdata_epithelial_CO <- round(100 * attr(PCAdata_epithelial_CO, "percentVar"), digits = 4)
```
...
PCAplot_CO <- ggplot(PCAdata_epithelial_CO,
                     aes(x = PC1, y = PC2,
                         ...
                         label= Sample_Name)) +
  geom_point(size = 3) +
  xlab(paste0("PC1: ", percentVar.PCAdata_epithelial_CO[1], "% variance")) +
  ylab(paste0("PC2: ", percentVar.PCAdata_epithelial_CO[2], "% variance")) +
  coord_fixed() +
  scale_y_continuous(breaks = seq(-10, 10, 5)) +
  scale_x_continuous(breaks = seq(-20, 20, 5)) +
  ...
  geom_text(size = 4, hjust = 0, vjust = 0)
PCAplot_MC
ggsave(filename = '~/R/Alina_RNAseq/EpithelialResponse/PCAplot_EpithelialResponse_ClinicalOutcome.png',
       plot = PCAplot_CO,
       dpi = 300,
       width = 10,
       height = 10,
...
head(PCAdata_epithelial_ERMC)
percentVar.PCAdata_epithelial_ERMC <- round(100 * attr(PCAdata_epithelial_ERMC, "percentVar"), digits = 4)
```
...
PCAplot_ERMC <- ggplot(PCAdata_epithelial_ERMC,
                       aes(x = PC1, y = PC2,
                           ...
                           label= Sample_Name)) +
  geom_point(size = 3) +
  xlab(paste0("PC1: ", percentVar.PCAdata_epithelial_ERMC[1], "% variance")) +
  ylab(paste0("PC2: ", percentVar.PCAdata_epithelial_ERMC[2], "% variance")) +
  coord_fixed() +
  scale_y_continuous(breaks = seq(-10, 10, 5)) +
  scale_x_continuous(breaks = seq(-20, 20, 5)) +
  ggtitle("PCA Plot - High Vs Low Inducer - EpithelialResponse_Microcolonies") +
  theme_classic() +
  geom_hline(yintercept = 0, color = "gray", size = 1) +
  geom_vline(xintercept = 0, color = "gray", size = 1) +
  theme(text = element_text(size = 15), axis.text = element_text(size = 15)) +
  ...
  geom_text(size = 4, hjust = 0, vjust = 0)
PCAplot_ERMC
ggsave(filename = '~/R/Alina_RNAseq/EpithelialResponse/PCAplot_EpithelialResponse_ER_Microcolonies.png',
       plot = PCAplot_ERMC,
       dpi = 300,
       width = 10,
       height = 10,
...
```{r}
PCAdata_epithelial_PL <- plotPCA(vsd, intgroup = c("Sample_Name", "phylogenomic_lineage"), returnData = TRUE)
head(PCAdata_epithelial_PL)
percentVar.PCAdata_epithelial_PL <- round(100 * attr(PCAdata_epithelial_PL, "percentVar"), digits = 4)
```
...
PCAplot_PL <- ggplot(PCAdata_epithelial_PL,
                       aes(x = PC1, y = PC2,
                           ...
                           label= Sample_Name)) +
  geom_point(size = 3) +
  xlab(paste0("PC1: ", percentVar.PCAdata_epithelial_PL[1], "% variance")) +
  ylab(paste0("PC2: ", percentVar.PCAdata_epithelial_PL[2], "% variance")) +
  coord_fixed() +
  scale_y_continuous(breaks = seq(-10, 10, 5)) +
  scale_x_continuous(breaks = seq(-20, 20, 5)) +
  ...
  geom_text(size = 4, hjust = 0, vjust = 0)
PCAplot_PL
ggsave(filename = '~/R/Alina_RNAseq/EpithelialResponse/PCAplot_EpithelialResponse_PhylogenomicLineage.png',
       plot = PCAplot_PL,
       dpi = 300,
       width = 10,
       height = 10,
...
head(PCAdata_epithelial_PG)
percentVar.PCAdata_epithelial_PG <- round(100 * attr(PCAdata_epithelial_PG, "percentVar"), digits = 4)
```
...
PCAplot_PG <- ggplot(PCAdata_epithelial_PG,
                     aes(x = PC1, y = PC2,
                         ...
                         label= Sample_Name)) +
  geom_point(size = 3) +
  xlab(paste0("PC1: ", percentVar.PCAdata_epithelial_PG[1], "% variance")) +
  ylab(paste0("PC2: ", percentVar.PCAdata_epithelial_PG[2], "% variance")) +
  coord_fixed() +
  scale_y_continuous(breaks = seq(-10, 10, 5)) +
  scale_x_continuous(breaks = seq(-20, 20, 5)) +
  ...
  geom_text(size = 4, hjust = 0, vjust = 0)
PCAplot_PG
ggsave(filename = '~/R/Alina_RNAseq/EpithelialResponse/PCAplot_EpithelialResponse_Phylogroup.png',
       plot = PCAplot_PG,
       dpi = 300,
       width = 10,
       height = 10,
...
percentVar.PCAdata_epithelial_IT <- round(100 * attr(PCAdata_epithelial_IT, "percentVar"), digits = 4)
```
...
PCAplot_IT <- ggplot(PCAdata_epithelial_IT,
                     aes(x = PC1, y = PC2,
                         ...
                         label= Sample_Name)) +
  geom_point(size = 3) +
  xlab(paste0("PC1: ", percentVar.PCAdata_epithelial_IT[1], "% variance")) +
  ylab(paste0("PC2: ", percentVar.PCAdata_epithelial_IT[2], "% variance")) +
  coord_fixed() +
  scale_y_continuous(breaks = seq(-10, 10, 5)) +
  scale_x_continuous(breaks = seq(-20, 20, 5)) +
  ...
  geom_text(size = 4, hjust = 0, vjust = 0)
PCAplot_IT
ggsave(filename = '~/R/Alina_RNAseq/EpithelialResponse/PCAplot_EpithelialResponse_IntiminType.png',
       plot = PCAplot_IT,
       dpi = 300,
       width = 10,
       height = 10,
...
```{r}
hist(res2_epithelial$pvalue[res2_epithelial$baseMean > 1], breaks = 50, col = "grey50", border = "blue")
```
...
```{r}
write.csv(DE_Genes_table_epithelial ,"~/R/Alina_RNAseq/DE_GenesTable_EpithelialResponse.csv")
