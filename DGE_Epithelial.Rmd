...
```
Now, process the results to pull out the top 20 up-regulated pathways, then further process that just to get the IDs. I can use these KEGG pathway IDs downstream for plotting.
...
```{r}
(pathwayplots <- sapply(keggresids, function(pid) pathview(gene.data = foldchanges, 
                                                pathway.id = pid, 
                                                species = "mouse")))
```
