...
```{r fig.height= 8, fig.width=8}
plot( upsetplot(GO_UPRegResults_epithelial))
```
...
plot( heatplot(GO_UPRegResults_epithelial))
...
plot( upsetplot(GO_DOWNRegResults_epithelial))
```

### Heat Plot
```{r fig.height= 20, fig.width=25}
plot(heatplot(GO_DOWNRegResults_epithelial))
```
