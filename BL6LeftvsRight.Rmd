...
```{r}
dds_Hposition <- DESeqDataSetFromMatrix(
...
saveplot <- function(plot, name) {
  ...
  ggsave(
    filename =
      glue("/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/{name}.png"),
    plot = plot,
    dpi = 300,
    width = 10,
    height = 10,
...
savingFunction <- function(plotname, metadatacolumn) {
  ...
  ggsave(
    filename =
      glue("/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/PCAplot_Hposition_{metadatacolumn}.png"),
    plot = plotname,
    dpi = 300,
    width = 25,
    height = 25,
...
(PCAplot_vst <- ggplot(
  ...
  ggtitle("PCA Plot - Right vs Left ") +
  scale_colour_manual(values = color_values) +
  theme.my.own)
#savingFunction(PCAplot_vst, "condition")
ggsave(
  filename = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/PCAplot_Hposition.png",
  plot = PCAplot_vst,
  dpi = 300,
  width = 10,
  height = 10,
...
(PCAplot_vst23 <- ggplot(
  ...
  theme.my.own)
ggsave(
  filename = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/PCAplot23_HpositionvsControl.png",
  plot = PCAplot_vst23,
  dpi = 300,
  width = 10,
  height = 10,
...
(PCAplot_vst34 <- ggplot(
  ...
  theme.my.own)
ggsave(
  filename = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/PCAplot34_HpositionvsControl.png",
  plot = PCAplot_vst34,
  dpi = 300,
  width = 10,
  height = 10,
...
```{r}
# PCAdata_Hposition_ERMC <- plotPCA(vsd,
#   intgroup = c("Sample_Name", "ER_microcolonies"),
#   returnData = TRUE
# )
# percentVar_Hposition_ERMC <- percentvar_calculation(PCAdata_Hposition_ERMC)
# (PCAplot_ERMC <- ggplot(
#   PCAdata_Hposition_ERMC,
#   aes(
#     x = PC1, y = PC2,
...
```{r}
# PCAdata_Hposition_PL <- plotPCA(vsd,
#   intgroup = c(
#     "Sample_Name",
...
#   # filename = '/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/Hclust_plot.tiff'
# ))
# Hclust_plot
```
...
write.csv(as.data.frame(resOrdered_Hposition),
  file = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/results_DGE.csv"
)
```
...
ggsave(
  filename = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/Volcano1_L2fcVsPvalue.png",
  plot = volcano1,
  dpi = 300,
  width = 5,
  height = 5,
...
ggsave(
  filename = "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/Volcano2_L2fcVsPadj.png",
  plot = volcano2,
  dpi = 300,
  width = 10,
  height = 10,
...
```{r}
write.csv(sigsdf_Hposition, "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/SignificantGenes.csv")
```
...
```{r}
write.csv(UpGene_Hposition, "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/UpGene_Hposition.csv")
write.csv(DownGene_Hposition, "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/DownGene_Hposition.csv")
```
...
GO_UPRegResults_Hposition <- enrichGO(
  gene = UPgene_ENS_ID,
  OrgDb = "org.Mm.eg.db",
  keyType = "ENSEMBL",
  ont = "BP",
...
```{r}
write.csv(GO_UpRegdf_Hposition, "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/GO_UpReg_results_Hposition.csv")
```

```{r fig.height=10, fig.width=10}
GO_UPReg_Barplot_Hposition <- plot(barplot(GO_UPRegResults_Hposition,
  showCategory = 22,
  font.size = 20,
...
```{r fig.height=10, fig.width=10}
GO_UPReg_Dotplot_Hposition <- plot(dotplot(GO_UPRegResults_Hposition,
  showCategory = 23,
  font.size = 20,
  title = "InfectedVsControl Up Regulated",
  label_format = 40
...
GO_UPReg_Cnetplot_Hposition <- plot(cnetplot(GO_UPRegResults_Hposition,
  showCategory = 13,
  font.size = 20,
  title = "InfectedVsControl Up Regulated",
  label_format = 50
...
GO_DOWNRegResults_Hposition <- enrichGO(
...
```{r}
write.csv(
  GO_DOWNRegdf_Hposition,
  "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/GO_DOWNReg_results_Epithelial.csv"
)
```
...
GO_DOWNReg_Barplot_Hposition <- plot(barplot(GO_DOWNRegResults_Hposition,
  font.size = 20,
  title = "InfectedVsControl Down Regulated",
  label_format = 60
))
...
#
# write.csv(gseaKEGG_results, "/home/keshavprasadgubbi/Documents/AlinaRnaSeq/Hposition/gseaOE_kegg.csv")
```
