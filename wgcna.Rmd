...
Gene Significance (GS) : the association of individual genes with interesting effectors(weight) can be quantified by GS, as the (absolute value of ) correlation between and effector. 
